function [out,M] = run_pcm_EEG_prepost_winning_pmf(varargin)
...
[pcm_data_EEG,LUT_EEG] = pcm_getData_EEG(timeWins,erpMode,'blocktype','pre-postL-postR',...
                                         'iseucnorm',iseucnorm);
...
if ~ismember('fitRes',p.UsingDefaults)
    ...
    % Model 4: Hemifield + Dec + Pmf_recal
    M{iModel}.type       = 'component';
    M{iModel}.numGparams = 3;
    M{iModel}.Gc(:,:,1)  = Gc_hemi;
    M{iModel}.Gc(:,:,2)  = Gc_dec;
    ...
    % Model 6: Hemifield_recal + Dec + Pmf
    M{iModel}.type       = 'component';
    M{iModel}.numGparams = 3;
    M{iModel}.Gc(:,:,1)  = Gc_hemi_recal;
    M{iModel}.Gc(:,:,2)  = Gc_dec;
    ...
    % Model 8: Hemifield_recal + Dec_recal
    M{iModel}.type       = 'component';
    M{iModel}.numGparams = 2;
    M{iModel}.Gc(:,:,1)  = Gc_hemi_recal;
    ...
    % Model 9: Hemifield_recal + Dec_recal + Pmf
    M{iModel}.type       = 'component';
    M{iModel}.numGparams = 3;
    M{iModel}.Gc(:,:,1)  = Gc_hemi_recal;
    M{iModel}.Gc(:,:,2)  = Gc_dec_recal;
    ...
    % Model 10: Hemifield_recal + Dec_recal + Pmf_recal
    M{iModel}.type       = 'component';
    M{iModel}.numGparams = 3;
    M{iModel}.Gc(:,:,1)  = Gc_hemi_recal;
    M{iModel}.Gc(:,:,2)  = Gc_dec_recal;
